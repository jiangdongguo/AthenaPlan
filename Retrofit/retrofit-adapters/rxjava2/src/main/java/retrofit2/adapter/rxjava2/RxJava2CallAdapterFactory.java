...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
  ...
  /** RxJava2CallAdapterFactory适配器构造函数
   *
   * @param scheduler 指定调度线程
   * @param isAsync 是否异步标志
   */
  ...
  /**
   * 创建RxJava2CallAdapter网络请求适配器对象
   */
  @Override
  public @Nullable CallAdapter<?, ?> get(
      Type returnType, Annotation[] annotations, Retrofit retrofit) {
    // 1. 根据返回类型，设置定义的标志位
    // 如Complete、Flowable、Single、Maybe，默认是Observable
